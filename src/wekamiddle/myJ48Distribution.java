...
public class myJ48Distribution implements Serializable{
	/** for serialization */
	private static final long serialVersionUID = -2937042732215378784L;
	...
	public myJ48Distribution(int numBags,int numClasses) {
		int i;
...
////  }
	...
	public myJ48Distribution(Instances source) throws Exception {    
	...
	public myJ48Distribution(Instances source, myJ48Split modelToUse) throws Exception {
		int index;
		Instance instance;
		double[] weights;
	...
	public myJ48Distribution(myJ48Distribution toMerge) {
		total = toMerge.total;
