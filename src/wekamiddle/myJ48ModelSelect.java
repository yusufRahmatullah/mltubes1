...
public class myJ48ModelSelect implements Serializable{
	/** for serialization */
	private static final long serialVersionUID = 8678098409069914912L;
	...
	public final myJ48Split selectModel(Instances data){
		...
		myJ48NoSplit noSplitModel = null;
		double averageInfoGain = 0;
		int validModels = 0;
		boolean multiVal = true;
		myJ48Distribution checkDistribution;
		Attribute attribute;
		double sumOfWeights;
		int i;
		try {
			...
			checkDistribution = new myJ48Distribution(data);
			noSplitModel = new myJ48NoSplit(checkDistribution);
