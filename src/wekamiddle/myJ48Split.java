...
public class myJ48Split implements Serializable{
	/** for serialization */
	private static final long serialVersionUID = 990069977738606664L;
	/** Distribution of class values. */
	protected myJ48Distribution m_distribution;
...
//  }
// 
	public final myJ48Distribution distribution() {
	...
	private void handleEnumeratedAttribute(Instances trainInstances) throws Exception {
		Instance instance;
		m_distribution = new myJ48Distribution(m_complexityIndex, trainInstances.numClasses());
	...
	private void handleNumericAttribute(Instances trainInstances) throws Exception {
		...
		m_distribution = new myJ48Distribution(2,trainInstances.numClasses());
		// Only Instances with known values are relevant.
		Enumeration enu = trainInstances.enumerateInstances();
		i = 0;
		while (enu.hasMoreElements()) {
...
//  
	public void resetDistribution(Instances data) throws Exception {
		...
		myJ48Distribution newD = new myJ48Distribution(insts, this);
	...
	private final double oldEnt(myJ48Distribution bags) {
	...
	private final double newEnt(myJ48Distribution bags) {
		double returnValue = 0;
		int i,j;
	...
	private final double splitEnt(myJ48Distribution bags,double totalnoInst){
		double returnValue = 0;
		double noUnknown;
		int i;
	...
	private final double gainRatiosplitCritValue(myJ48Distribution bags, double totalnoInst, double numerator){
		double denumerator;
		// Compute split info.
	...
	public final double infoGainsplitCritValue(myJ48Distribution bags,double totalNoInst, double oldEnt) {
		double numerator;
		double noUnknown;
		double unknownRate;
		noUnknown = totalNoInst-bags.total();
	...
	public final double infoGainsplitCritValue(myJ48Distribution bags, double totalNoInst) {
		double numerator;
		double noUnknown;
		double unknownRate;
		noUnknown = totalNoInst-bags.total();
