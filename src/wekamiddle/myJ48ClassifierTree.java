...
public class myJ48ClassifierTree implements Serializable{
	/** for serialization */
...
//  }
//
	private double getEstimatedErrorsForDistribution(myJ48Distribution theDistribution){
	...
	private double getTrainingErrors(){
		...
		if (m_isLeaf){
			...
			for (i=0;i<m_sons.length;i++){
				errors+=m_sons[i].getTrainingErrors();
			}
			return errors;
		}
	}
